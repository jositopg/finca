...
- **Dashboard**: operativo del día a día — resumen del mes/año, tareas pendientes, cobros de renta, agua y luz a repercutir este mes, acceso rápido a facturas de agua/luz, listado de propiedades. **Los avisos (contrato por vencer, revisión de renta, certificado energético, fianza) NO van agregados aquí** — viven dentro de la ficha y tarjeta de cada propiedad.
- **Estadísticas**: gráficos agregados (evolución del rendimiento neto por año, gastos por categoría, ranking de rentabilidad entre propiedades, agua y luz a repercutir en el año). Cualquier gráfico/estadística agregada nueva va aquí, no en el Dashboard. La app solo empieza a acumular histórico útil desde 2026, así que la evolución anual (`EvolucionAnual`, requiere ≥2 años con datos) no se mostrará hasta que haya suficiente histórico. El listado operativo de agua/luz a repercutir **este mes** va en Inicio (`RepercutirSuministros`); el del año, aquí. En la ficha, `RepercutirSuministrosFicha` desglosa cada factura por mes facturado (importe, incluido, a repercutir) y deja copiar el texto para el inquilino.
